...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gwcelery-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6203&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gwcelery-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gwcelery` can be installed with:

```
conda install gwcelery
```

It is possible to list all of the versions of `gwcelery` available on your platform with:
